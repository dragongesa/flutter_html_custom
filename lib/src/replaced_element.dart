...
class IframeYoutubeContentElement extends ReplacedElement {
  final String src;
  final double width;
  final double height;
  final NavigationDelegate navigationDelegate;

  IframeYoutubeContentElement({
    String name,
    Style style,
    this.src,
    this.width,
...
ReplacedElement parseReplacedElement(
  ...
  switch (element.localName) {
    ...
    case "iframe":
      if (element.attributes['src'].contains("youtube")){ 
        return IframeYoutubeContentElement(
          name: "iframe",
